                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="table-responsive">
                                        <form method="POST" action="{{route('manage.revenue.insert.manage-revenue-csi-pam-fdi-yearly')}}"  id="indus">
                                            @csrf
                                        ...
                                        <table id="example" class="table table-striped table-bordered nowrap" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                <td>{{@$get_time_data->year}}</td>
                                                    ...
                                                    <td class="rm07">
                                                                @if(@$data[0]->id)    
                                                                <a href="{{route('manage.revenue.edit.manage-revenue-csi-pam-fdi-yearly',@$data[0]->id)}}" >Edit </a>
                                                                @endif
