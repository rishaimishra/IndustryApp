                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="table-responsive">
                                        <form method="POST" action="{{route('manage.other.insert-ml-domestic-service-yearly')}}"  id="indus">
                                            @csrf
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="rm07">
                                                                ...
                                                                <a href="{{route('manage.other.edit-ml-domestic-service-yearly',@$data[0]->id)}}" >Edit </a>
                                                                @endif
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <ol class="breadcrumb pull-right">
                                                    ...
                                                    <li class="active"><a href="{{route('manage.other-ml-domestic-service-yearly')}}" class="btn btn-primary">Cancel</a></li>
