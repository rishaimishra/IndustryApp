...
@section('title')
<title>Admin | Manage Production Sales Export Edit (Yearly)</title>
@endsection
...
<div class="content-page">
	...
	<div class="content">
		<div class="wraper container-fluid">
			<div class="row">
				<div class="col-sm-12">
					<h4 class="pull-left page-title">Manage Production Sales Export Edit (Yearly)</h4>
					<ol class="breadcrumb pull-right">
                        <li class="active"><a href="{{route('manage.sales.export.ml-domestic-construction.yearly')}}"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</a></li>
                    </ol>
				</div>
			</div>
					...
					<div>
						...
						<div class="panel panel-default panel-fill">
							...
							<div class="panel-body rm02 rm04">
								<form role="form" action="{{route('manage.sales.export.update.ml-domestic-construction.yearly')}}" id="frm" method="post" enctype="multipart/form-data">
									@csrf
