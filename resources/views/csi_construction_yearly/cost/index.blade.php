                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="table-responsive">
                                        <form method="POST" action="{{route('manage.cost.save.save.next.csi-construction.yearly')}}"  id="indus">
                                            @csrf
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="rm07">
                                                                ...
                                                                @if(@$data[0]->id && @$data[0]->type=="Y")
                                                                <a href="{{route('manage.cost.edit.csi-construction.yearly',@$data[0]->id)}}" >Edit </a>
                                                                @endif
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <ol class="breadcrumb pull-right">
                                                    ...
                                                    <li class="active"><a href="{{route('manage.cost.csi-construction.yearly')}}" class="btn btn-primary">Cancel</a></li>
