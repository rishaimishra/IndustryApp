                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="table-responsive">
                                        <form method="POST" action="{{route('manage.other.cost.other.save.save.next.csi-construction-fdi.yearly')}}"  id="indus">
                                            @csrf
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="rm07">
                                                                ...
                                                                @if(@$data[0]->id && @$data[0]->type=="Y")
                                                                <a href="{{route('manage.other.cost.other.edit.csi-construction-fdi.yearly',@$data[0]->id)}}" >Edit </a>
                                                                @endif
