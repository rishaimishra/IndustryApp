			...
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="csi_manufacturing_div" id="csi_manufacturing_div">	
									...
									<div class="csi_manufacturing_others" @if(@$data->business_status=="oth") style="display:block" @else style="display:none" @endif >
...
<script type="text/javascript">
	$(document).ready(function(){
		@if (@$data->business_status=="op")
					...
					$('.csi_manufacturing_others :input').prop("disabled", true);
					
		@elseif(@$data->business_status=="oth")
		           $('.csi_manufacturing_others :input').prop("disabled", false);
...
<script type="text/javascript">
				...
				if(business_status=="op"){
					...
					$('.csi_manufacturing_others').css('display','none');
				...
				if(business_status=="oth"){
					...
					$('.csi_manufacturing_others').css('display','block');
