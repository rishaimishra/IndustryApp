            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <ol class="breadcrumb pull-right">
                        ...
                        <li class="active"><a href="{{route('manage.training.add-csi-construction-fdi')}}" class="btn btn-primary">+ Add Data</a></li>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="table-responsive">
                                        <form method="POST" action="{{route('manage.training.save.save.next-csi-construction-fdi')}}"  id="indus">
                                            @csrf
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="rm07">
                                                        ...
                                                        <div class="show-actions" id="show-{{$value->id}}" style="display: none;">
                                                            ...
                                                            <ul>
                                                                @if(@$value->year==@$year->year && @$value->status!="IP")
                                                                <li><a href="{{route('manage.training.edit-csi-construction-fdi',@$value->id)}}" >Edit </a></li>
                                                                @endif
                                                                
                                                                <li><a href ="{{route('manage.training.delete-csi-construction-fdi',['id'=>@$value->id])}}"data-bs-toggle="modal" data-bs-target="#exampleModal">Delete </a></li>
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <ol class="breadcrumb pull-right">
                                        ...
                                        <li class="active"><a href="{{route('manage.training-csi-construction-fdi')}}" class="btn btn-primary">Cancel</a></li>
