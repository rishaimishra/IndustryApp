            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <ol class="breadcrumb pull-right">
                        ...
                        <li class="active"><a href="{{route('manage.employe.add.manage-employment-record-csi-pam-fdi')}}" class="btn btn-primary">+ Add Data</a></li>

                        <li class="active"><a href="{{route('manage.employe.statistics.manage-employment-record-csi-pam-fdi')}}" class="btn btn-primary"> View Statistics</a></li>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="table-responsive">
                                        <form method="POST" action="{{route('manage.employe.save.save.next.manage-employment-record-csi-pam-fdi')}}"  id="indus">
                                            @csrf
                                                   ...
                                                   <td><input type="text"    name="addmore[{{$key}}][email]" class="form-control email"  value="{{@$value->email}}" style="width: 200px;"></td>
                                                    ...
                                                    <td class="rm07">
                                                        ...
                                                        <div class="show-actions" id="show-{{$value->id}}" style="display: none;">
                                                            ...
                                                            <ul>
                                                                @if(@$value->year==@$year->year && @$value->status!="IP")
                                                                <li><a href="{{route('manage.employe.edit.manage-employment-record-csi-pam-fdi',@$value->id)}}" >Edit </a></li>
                                                                @endif
                                                                
                                                                <li><a href ="{{route('manage.employe.delete.manage-employment-record-csi-pam-fdi',['id'=>@$value->id])}}"data-bs-toggle="modal" data-bs-target="#exampleModal">Delete </a></li>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <ol class="breadcrumb pull-right">
                                                    ...
                                                    <li class="active"><a href="{{route('manage.employe.manage-employment-record-csi-pam-fdi')}}" class="btn btn-primary">Cancel</a></li>
