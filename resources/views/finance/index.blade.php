                                                ...
                                                <tr>
                                                    ...
                                                    <td class="rm07">
                                                        ...
                                                        <div class="show-actions" id="show-{{$value->id}}" style="display: none;">
                                                            ...
                                                            <ul>
                                                                <li><a href="{{route('manage.finance.edit',@$value->id)}}" >Edit </a></li>
                                                                
                                                                <li><a href ="{{route('manage.finance.delete',['id'=>@$value->id])}}"data-bs-toggle="modal" data-bs-target="#exampleModal">Delete </a></li>
