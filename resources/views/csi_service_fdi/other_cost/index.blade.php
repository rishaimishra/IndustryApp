...
@section('title')
<title>Manage Other Cost Details</title>
@endsection
...
<div class="content-page">
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">Manage Other Cost Details</h4>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="table-responsive">
                                        <form method="POST" action="{{route('manage.other.cost.other.save.save.next.csi-service-fdi')}}"  id="indus">
                                            @csrf
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="rm07">
                                                                ...
                                                                @if(@$data[0]->id )
                                                                <a href="{{route('manage.other.cost.other.edit.csi-service-fdi',@$data[0]->id)}}" >Edit </a>
                                                                @endif
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <ol class="breadcrumb pull-right">
                                                    ...
                                                    <li class="active"><a href="{{route('manage.other.cost.other.csi-service-fdi')}}" class="btn btn-primary">Cancel</a></li>
