			...
			<div class="row">
				<div class="col-sm-12">
					...
					<ol class="breadcrumb pull-right">
                        <li class="active"><a href="{{route('manage.service.manufacture.ml-domestic-construction')}}"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</a></li>
                    </ol>
				</div>
			</div>
					...
					<div>
						...
						<div class="panel panel-default panel-fill">
							...
							<div class="panel-body rm02 rm04">
								<form role="form" action="{{route('manage.service.manufacture.delete.submit.ml-domestic-construction')}}" id="frm" method="post" enctype="multipart/form-data">
									@csrf
