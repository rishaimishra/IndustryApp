...
@section('title')
<title>Admin | Manage Cost Edit</title>
@endsection
...
<div class="content-page">
	...
	<div class="content">
		<div class="wraper container-fluid">
			<div class="row">
				<div class="col-sm-12">
					<h4 class="pull-left page-title">Manage Cost Edit</h4>
					<ol class="breadcrumb pull-right">
                        <li class="active"><a href="{{route('manage.cost.ml-domestic-construction')}}"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</a></li>
                    </ol>
				</div>
			</div>
					...
					<div>
						...
						<div class="panel panel-default panel-fill">
							...
							<div class="panel-body rm02 rm04">
								<form role="form" action="{{route('manage.cost.update.ml-domestic-construction')}}" id="frm" method="post" enctype="multipart/form-data">
									@csrf
									...
									<div class="form-group rm03">
										...
										<input type="text"  class="form-control"  placeholder="Enter Labour"  name="labour" value="{{@$data->labour}}" required>
									</div>
									...
									<div class="form-group rm03" >
										...
										<input type="text"  class="form-control"  placeholder="Enter POL"  name="pol" value="{{@$data->pol}}" required>
									</div>

									<div class="form-group rm03">
										<label for="title">General Administration</label>
										<input type="text"  class="form-control"  placeholder="Enter General Administration" value="{{@$data->general}}"  name="general" required>
									</div>


									<div class="form-group rm03">
										<label for="title">RM Transportation</label>
										<input type="text"  class="form-control"  placeholder="Enter RM Transportation" value="{{@$data->rm}}"  name="rm" required>
									</div>

									<div class="form-group rm03">
										<label for="title">Other Costs</label>
										<input type="text"  class="form-control"  placeholder="Enter Land Lease Rent" value="{{@$data->others}}"  name="others" required>
									</div>
