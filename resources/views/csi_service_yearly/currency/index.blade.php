            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <ol class="breadcrumb pull-right">
                        ...
                        <li class="active"><a href="{{route('manage.currency.add.yearly')}}" class="btn btn-primary">+ Add Data</a></li>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="table-responsive">
                                        <form method="POST" action="{{route('manage.currency.yearly.save.save.next')}}"  id="indus">
                                            @csrf
                                                    ...
                                                    <td class="rm07">
                                                        ...
                                                        <div class="show-actions" id="show-{{$value->id}}" style="display: none;">
                                                            ...
                                                            <ul>
                                                                ...
                                                                @if(@$value->year==@$year->year && @$value->status!="IP" && @$value->type=="Y")
                                                                <li><a href="{{route('manage.currency.edit.yearly',@$value->id)}}" >Edit </a></li>
                                                                @endif
                                                                
                                                                <li><a href ="{{route('manage.currency.delete.yearly',['id'=>@$value->id])}}"data-bs-toggle="modal" data-bs-target="#exampleModal">Delete </a></li>
