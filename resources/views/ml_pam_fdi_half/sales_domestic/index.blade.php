                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="table-responsive">
                                        <form method="POST" action="{{route('manage.sales.domestic.ml-pam-fdi.save.save.next')}}"  id="indus">
                                            @csrf
                                                    ...
                                                    <td class="rm07">
                                                        ...
                                                        <div class="show-actions" id="show-{{$value->id}}" style="display: none;">
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li><a href="{{route('manage.sales.domestic.edit.ml-pam-fdi',@$value->id)}}" >Edit </a></li>
                                                                @endif
