...
@section('title')
<title>Admin | Manage Production Manufacturing Add</title>
@endsection
...
<div class="content-page">
	...
	<div class="content">
		<div class="wraper container-fluid">
			<div class="row">
				<div class="col-sm-12">
					<h4 class="pull-left page-title">Manage Production Manufacturing Add</h4>
					<ol class="breadcrumb pull-right">
                        <li class="active"><a href="{{route('manage.production.manufacture.ml-pam-fdi-production-manufactureing')}}"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</a></li>
                    </ol>
				</div>
			</div>
					...
					<div>
						...
						<div class="panel panel-default panel-fill">
							...
							<div class="panel-body rm02 rm04">
								<form role="form" action="{{route('manage.production.manufacture.insert.ml-pam-fdi-production-manufactureing')}}" id="frm" method="post" enctype="multipart/form-data">
									@csrf
