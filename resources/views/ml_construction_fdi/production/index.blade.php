            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <ol class="breadcrumb pull-right">
                        ...
                        <li class="active"><a href="{{route('manage.service.manufacture.add.ml-construction-fdi')}}" class="btn btn-primary">+ Add New Service</a></li>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="table-responsive">
                                        <form method="POST" action="{{route('manage.service.manufacture.ml-construction-fdi.save.save.next')}}"  id="indus">
                                            @csrf
                                                   ...
                                                   @endif
                                                    ...
                                                    <td class="rm07">
                                                        ...
                                                        <div class="show-actions" id="show-{{$value->id}}" style="display: none;">
                                                            ...
                                                            <ul>
                                                                @if(@$value->year==@$year->year && @$value->status!="IP")
                                                                <li><a href="{{route('manage.service.manufacture.edit.ml-construction-fdi',@$value->id)}}" >Edit </a></li>
                                                                @endif
                                                                
                                                                <li><a href ="{{route('manage.service.manufacture.delete.ml-construction-fdi',['id'=>@$value->id])}}"data-bs-toggle="modal" data-bs-target="#exampleModal">Delete </a></li>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <ol class="breadcrumb pull-right">
                                        ...
                                        <li class="active"><a href="{{route('manage.service.manufacture.ml-construction-fdi')}}" class="btn btn-primary">Cancel</a></li>
