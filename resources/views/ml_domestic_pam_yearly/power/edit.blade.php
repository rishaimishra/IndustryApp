...
@section('title')
<title>Admin | Manage Power Edit (Yearly)</title>
@endsection
...
<div class="content-page">
	...
	<div class="content">
		<div class="wraper container-fluid">
			<div class="row">
				<div class="col-sm-12">
					<h4 class="pull-left page-title">Manage Power Edit (Yearly)</h4>
					<ol class="breadcrumb pull-right">
                        <li class="active"><a href="{{route('manage.power.ml-domestic-pam.yearly')}}"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</a></li>
                    </ol>
				</div>
			</div>
					...
					<div>
						...
						<div class="panel panel-default panel-fill">
							...
							<div class="panel-body rm02 rm04">
								<form role="form" action="{{route('manage.power.update.ml-domestic-pam.yearly')}}" id="frm" method="post" enctype="multipart/form-data">
									@csrf
									...
									<div class="form-group rm03" >
										...
										<option value="KW" @if(@$data->unit=="KW") selected @endif>KW</option>
										<option value="MW" @if(@$data->unit=="MW") selected @endif>MW</option>
										</select>
									</div>


									<div class="form-group rm03">
										<label for="title">Approved Power Capacity</label>
										<input type="text"  class="form-control"  placeholder="Enter Approved Power Capacity"  name="approved_power" value="{{@$data->approved_power}}" required>
									</div>
									...
									<div class="form-group rm03" >
										<label for="title">Energy Consumption</label>
										<input type="number"  class="form-control"  placeholder="Enter Energy Consumption"  name="energy" value="{{@$data->energy}}" required>
									</div>

									<div class="form-group rm03">
										<label for="title">Energy Consumption Charges (Nu. Million)</label>
										<input type="number"  class="form-control"  placeholder="Enter Energy Consumption Charges (Nu. Million)" value="{{@$data->charges}}"  name="charges" required>
									</div>
