            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <ol class="breadcrumb pull-right">
                        ...
                        {{-- <li class="active"><a href="{{route('manage.finance.add.ml-pam-fdi-yearly')}}" class="btn btn-primary">+ Add Data</a></li> --}}
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="table-responsive">
                                        <form method="POST" action="{{route('manage.finance.insert.ml-pam-fdi-yearly')}}"  id="indus">
                                            @csrf
                                        ...
                                        <table id="example" class="table table-striped table-bordered nowrap" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="rm07">
                                                                @if(@$data[0]->id)    
                                                                <a href="{{route('manage.finance.edit.ml-pam-fdi-yearly',@$data[0]->id)}}" >Edit </a>
                                                                @endif
