					...
					<div>
						...
						<div class="panel panel-default panel-fill">
							...
							<div class="panel-body rm02 rm04">
								<form role="form" action="{{route('manage.production.manufacture.update.ml-pam-fdi-production-manufactureing.yearly')}}" id="frm" method="post" enctype="multipart/form-data">
									@csrf
