...
@section('title')
<title>Admin | Manage Production Manufacturing Add (Yearly)</title>
@endsection
...
<div class="content-page">
	...
	<div class="content">
		<div class="wraper container-fluid">
			<div class="row">
				<div class="col-sm-12">
					<h4 class="pull-left page-title">Manage Production Manufacturing Add (Yearly)</h4>
					<ol class="breadcrumb pull-right">
                        <li class="active"><a href="{{route('manage.production.manufacture.ml-pam-fdi-production-manufactureing.yearly')}}"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</a></li>
                    </ol>
				</div>
			</div>
					...
					<div>
						...
						<div class="panel panel-default panel-fill">
							...
							<div class="panel-body rm02 rm04">
								<form role="form" action="{{route('manage.production.manufacture.insert.ml-pam-fdi-production-manufactureing.yearly')}}" id="frm" method="post" enctype="multipart/form-data">
									@csrf

									<div class="form-group rm03">
										<label for="title">Year</label>
										<input type="number"  class="form-control"  placeholder="Enter year"  name="year" value="{{@$get_time_data->year}}">
									</div>
									...
									<div class="form-group rm03">
										...
										<input type="text"  class="form-control"  placeholder="Enter Name of Finished Product (s)"  name="product" >
									</div>
									...
									<div class="form-group rm03">
										...
										<input type="number"  class="form-control"  placeholder="Enter Ex-factory Price (Nu.)"  name="price" >
									</div>
