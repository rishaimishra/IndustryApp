...
@section('title')
<title>Half Yearly Data Submission</title>
@endsection
...
<div class="content-page">
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">Half Yearly Data Submission</h4>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class=" panel panel-default" style="padding: 15px;">
                                       @if(@$currency>0)<i class="fa fa-check" aria-hidden="true" style="font-size:25px;color: green;"></i> @else <i class="fa fa-times" aria-hidden="true" style="font-size:25px;color: red;"></i> @endif Manage Currency Conversion
                                    </div>

                                    <div class=" panel panel-default" style="padding: 15px;">
                                       @if(@$power>0)<i class="fa fa-check" aria-hidden="true" style="font-size:25px;color: green;"></i> @else <i class="fa fa-times" aria-hidden="true" style="font-size:25px;color: red;"></i> @endif Manage Power Consumption 
                                    </div>
                                    ...
                                    <div class=" panel panel-default" style="padding: 15px;">
                                        @if(@$production>0 && @$sales_domestic==0 && @$sales_export==0 && @$raw_material>0 && @$currency>0 && @$power>0 && @$employee>0)
