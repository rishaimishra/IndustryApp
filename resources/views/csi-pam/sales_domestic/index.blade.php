...
@section('title')
<title>Manage Production Sales In Domestic (Yearly)</title>
@endsection
...
<div class="content-page">
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">Manage Production Sales In Domestic (Yearly)</h4>
                    <ol class="breadcrumb pull-right">
                         
                        <li class="active"><a href="{{route('manage.sales.domestic.add.yearly')}}" class="btn btn-primary">+ Add Data</a></li>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="rm07">
                                                        ...
                                                        <div class="show-actions" id="show-{{$value->id}}" style="display: none;">
                                                            ...
                                                            <ul>
                                                                <li><a href="{{route('manage.sales.domestic.edit.yearly',@$value->id)}}" >Edit </a></li>
                                                                
                                                                <li><a href ="{{route('manage.sales.domestic.delete.yearly',['id'=>@$value->id])}}"data-bs-toggle="modal" data-bs-target="#exampleModal">Delete </a></li>
