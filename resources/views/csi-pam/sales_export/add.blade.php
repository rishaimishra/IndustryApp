...
@section('title')
<title>Admin | Manage Production Sales Export Add (Yearly)</title>
@endsection
...
<div class="content-page">
	...
	<div class="content">
		<div class="wraper container-fluid">
			<div class="row">
				<div class="col-sm-12">
					<h4 class="pull-left page-title">Manage Production Sales Export Add (Yearly)</h4>
					...
					<div>
						...
						<div class="panel panel-default panel-fill">
							...
							<div class="panel-body rm02 rm04">
								<form role="form" action="{{route('manage.sales.export.insert.yearly')}}" id="frm" method="post" enctype="multipart/form-data">
									@csrf
