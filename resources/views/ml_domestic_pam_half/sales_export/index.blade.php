                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="table-responsive">
                                        <form method="POST" action="{{route('manage.sales.export.ml.pam.domestic.save.save.next')}}"  id="indus">
                                            @csrf
                                                    ...
                                                    <td class="rm07">
                                                        ...
                                                        <div class="show-actions" id="show-{{$value->id}}" style="display: none;">
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li><a href="{{route('manage.sales.export.edit.ml.pam.domestic',@$value->id)}}" >Edit </a></li>
                                                                @endif
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <ol class="breadcrumb pull-right">
                                        ...
                                        <li class="active"><a href="{{route('manage.sales.export.ml.pam.domestic')}}" class="btn btn-primary">Cancel</a></li>
