...
@section('title')
<title>Admin | Manage Production Sales Domestic Delete</title>
@endsection
...
<div class="content-page">
	...
	<div class="content">
		<div class="wraper container-fluid">
			<div class="row">
				<div class="col-sm-12">
					<h4 class="pull-left page-title">Manage Production Sales Domestic Delete</h4>
					<ol class="breadcrumb pull-right">
                        <li class="active"><a href="{{route('manage.sales.domestic')}}"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</a></li>
                    </ol>
				</div>
			</div>
