                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="table-responsive">
                                        <form method="POST" action="{{route('manage.other.cost.other.save.save.next.csi-service')}}"  id="indus">
                                            @csrf
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="rm07">
                                                                ...
                                                                @if(@$data[0]->id )
                                                                <a href="{{route('manage.other.cost.other.edit.csi-service',@$data[0]->id)}}" >Edit </a>
                                                                @endif
