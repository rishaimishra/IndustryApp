                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="table-responsive">
                                        <form method="POST" action="{{route('manage.cost.save.save.next.ml-services-fdi')}}"  id="indus">
                                            @csrf
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="rm07">
                                                                ...
                                                                @if(@$data[0]->id)
                                                                <a href="{{route('manage.cost.edit.ml-services-fdi',@$data[0]->id)}}" >Edit </a>
                                                                @endif
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <ol class="breadcrumb pull-right">
                                                    ...
                                                    <li class="active"><a href="{{route('manage.cost.ml-services-fdi')}}" class="btn btn-primary">Cancel</a></li>
