    ...
    <div style="max-width:640px; margin:0 auto;">
        ...
        <div style="max-width:620px; border:1px solid #d9d8d8; margin:0 0; padding:15px; ">
            ...
            <div style="display:block; overflow:hidden; width:100%;">
                ...
                Dear {{@$data['name']}},
                <p>
                   Your email has been changed by admin successfully.Please find your new email below.Use This email as login credential.Password remains same.
                   <p>Username : {{@$data['change_email']}}</p>
                </p>
