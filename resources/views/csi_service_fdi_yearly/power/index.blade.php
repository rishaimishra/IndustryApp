                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="table-responsive">
                                        <form method="POST" action="{{route('manage.power.yearly.save.save.next')}}"  id="indus">
                                            @csrf
                                            ...
                                            <tbody>
                                               {{--  @if(@$data->isNotEmpty())
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="rm07">
                                                        @if(@$data[0]->approved_power)
                                                                <a href="{{route('manage.power.edit.yearly',@$data[0]->id)}}" >Edit </a>
                                                        @endif
                                                    </td>
                                                </tr>
                                                {{-- @endforeach
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <ol class="breadcrumb pull-right">
                                                    ...
                                                    <li class="active"><a href="{{route('manage.power.yearly')}}" class="btn btn-primary">Cancel</a></li>
