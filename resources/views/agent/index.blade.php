                                                ...
                                                <tr>
                                                    ...
                                                    <td class="rm07">
                                                        ...
                                                        <div class="show-actions" id="show-{{$value->id}}" style="display: none;">
                                                            ...
                                                            <ul>
                                                                <li><a href="{{route('manage.agent.edit',@$value->id)}}" >Edit </a></li>
                                                                @if(@$value->status=="A")
                                                                <li><a href="{{route('manage.agent.status',@$value->id)}}" >Inactive </a></li>
                                                                @else
                                                                <li><a href="{{route('manage.agent.status',@$value->id)}}" >Active </a></li>
                                                                @endif


                                                                 <li><a href="{{route('manage.agent.delete',@$value->id)}}" onclick="return confirm('Are sure want to delete the data ?')">Delete </a></li>


                                                                 <li><a href="{{route('manage.industry.reset',@$value->id)}}" onclick="return confirm('Are sure want to reset the password ?')">Reset Password </a></li>
                                                             </ul>
                                                        </div>
                                                    </td>
                                                </tr>
